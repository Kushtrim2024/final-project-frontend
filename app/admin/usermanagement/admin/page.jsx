...
export default function AdminUsersPage() {
  ...
  async function load() {
    ...
    try {
      ...
      setErr(e.message || "List could not be retrieved.");
    } finally {
      setLoading(false);
    }
  }
  ...
  useEffect(() => {
    load(); // pull data on first startup
  ...
  async function handleAdd(e) {
    ...
    try {
      ...
      setAddErr(e.message || "Admin adding error.");
    }
  }
  ...
  return (
    <div className="p-6 text-gray-800">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-2xl font-bold">Admin - User Management (Admins)</h2>
        <button
